...
function ConeTip({ active, payload }) {
  ...
  return (
    <div style={{ ...TT, padding: '8px 12px', minWidth: 120 }}>
      <div style={{ color: '#f1f5f9', fontWeight: 700, fontSize: 14, fontFamily: "'IBM Plex Mono', ui-monospace, monospace" }}>
        ${fmt(Math.round(d.p50))}
      </div>
      <div style={{ color: '#64748b', fontSize: 10, marginTop: 3 }}>
        Trade #{d.trade} median
      </div>
      <div style={{ color: '#475569', fontSize: 9, marginTop: 2, fontFamily: "'IBM Plex Mono', ui-monospace, monospace" }}>
